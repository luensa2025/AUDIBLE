...
const Index = () => {
  return (
    <main className="overflow-x-hidden">
      ...
      <a
        href="https://wa.me/573114083525?text=Hola%2C%20quisiera%20m%C3%A1s%20informaci%C3%B3n..."
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Contactar por WhatsApp"
        className="fixed bottom-6 right-6 z-50 w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform duration-300 hover:shadow-[0_0_20px_rgba(37,211,102,0.4)]"
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="36" height="36" fillRule="evenodd" clipRule="evenodd">
